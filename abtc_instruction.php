...
<article id="content" style="font-size: 17px !important;">
	<div class="wrapper">
	    <div class="box1">
      		<h2 class="color3"><strong>H</strong>ướng dẫn đăng ký <span>Trực tuyến - cấp thẻ ABTC</span></h2>
      		<hr class="bg-black" />
			...
			<label class="input-control checkbox small-check">
		        ...
		        <span class="caption">Tôi đã đọc kỹ nội dung trên và muốn đăng ký xin cấp thẻ ABTC.</span>
		    </label>
			<br /><a href="abtc_regis.html" class="button bg-black fg-white" id="dongy"><span class="mif-checkmark"></span> Bắt đầu đăng ký</a>
	    </div>
	</div>
</article>
