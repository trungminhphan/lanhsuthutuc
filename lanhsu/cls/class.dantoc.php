...
class DanToc{
	...
	public function __construct(){
		...
		$this->_collection = $this->_mongo->getCollection(DanToc::COLLECTION);
	}
	...
	public function insert(){
		return $this->_collection->insert(array('_id' => new MongoId($this->id), 'ten'=>$this->ten, 'id_user' => new MongoId($this->id_user)));
	}
